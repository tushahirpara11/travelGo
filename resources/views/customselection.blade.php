			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						<div class="form">
							<form method="POST" action="{{route('customview')}}">
								{{csrf_field()}}
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												...
												<select name="place[]" multiple="multiple" class="selectpicker show-tick form-control" title="Select placeholder" data-selected-text-format="count > 6" data-done-button="true" data-done-button-text="OK" required="">
													@if(isset($places))
													@for($i=0;$i<count($places);$i++) <option value="{{$places[$i]->place_id}}">{{$places[$i]->place_name}}</option>
														@endfor
														@endif
												</select>
											</div>
										...
										<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												...
												<select name="hotel" class="selectpicker show-tick form-control" title="Select placeholder" data-selected-text-format="count > 6" data-done-button="true" data-done-button-text="OK" required="">
													@if(isset($hotel))
													@for($i=0;$i<count($hotel);$i++) <option value="{{$hotel[$i]->hotel_id}}">{{$hotel[$i]->hotel_name}}</option>
														@endfor
														@endif
												</select>
											</div>
										...
										<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												<div class="form-group form-spin-group">
													<label>Adult</label>
													<input onkeypress="return NumberOnly(event);" name="adult" type="text" class="form-control form-spin" value="1" required="" />
												</div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-6">
											<div class="form-group">
												<div class="form-group form-spin-group">
													<label>Child</label>
													<input onkeypress="return NumberOnly(event);" name="child" type="text" class="form-control form-spin" value="1" required="" />
												</div>
											</div>
										</div>
										<div class="mb-40"></div>
