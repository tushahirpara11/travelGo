...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::asset('backend/img/favicon.ico') }}" type="image/x-icon" />
    ...
    <link href="{{ URL::asset('backend/plugins/iCheck/square/blue.css') }}" rel="stylesheet" type="text/css" />
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="javascript:void(0)"><b>TravelGo</b></a>
        </div>
        <!-- /.login-logo -->
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4" style="float:right;">
                        <a data-toggle="modal" href="{{url('/')}}" class="block line18 mt-1">User Login</a>
                    </div>
                </div>
            </form>
    ...
    <!-- iCheck -->
    <script src="{{ URL::asset('backend/plugins/iCheck/icheck.min.js') }}" type="text/javascript"></script>
    <script>
        $(function() {
            $('input').iCheck({
