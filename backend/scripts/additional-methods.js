!function (t) {
    ...
    !function () {
        ...
        var i, n, r = "string" == typeof d ? d.replace(/\s/g, "").replace(/,/g, "|") : "image/*", o = this.optional(a);
        if (o)
            return o;
        ...
        if (t = t.replace(/([~!@#$%^&*()_+=`{}\[\]\-|\\:;'<>,.\/? ])+/g, ""), 11 !== t.length)
            return!1;
        var e, a, d, i, n = 0;
        ...
        return!1
    }, "Please specify a valid CPF number"), t.validator.addMethod("creditcardtypes", function (t, e, a) {
        if (/[^0-9\-]+/.test(t))
            return!1;
        t = t.replace(/\D/g, "");
        var d = 0;
        ...
        var d, i = "string" == typeof a, n = i ? a : a[0], r = i ? !0 : a[1];
        ...
        var a, d, i, n, r, o = !1, s = /^\d{1,2}\/\d{1,2}\/\d{4}$/;
        return s.test(t) ? (a = t.split("/"), d = parseInt(a[0], 10), i = parseInt(a[1], 10), n = parseInt(a[2], 10), r = new Date(Date.UTC(n, i - 1, d, 12, 0, 0, 0)), o = r.getUTCFullYear() === n && r.getUTCMonth() === i - 1 && r.getUTCDate() === d ? !0 : !1) : o = !1, this.optional(e) || o
        ...
        if (this.optional(e))
            return!0;
        var a, d, i, n, r, o, s, l, u, c = t.replace(/ /g, "").toUpperCase(), f = "", A = !0, h = "", p = "";
        if (a = c.substring(0, 2), o = {AL: "\\d{8}[\\dA-Z]{16}", AD: "\\d{8}[\\dA-Z]{12}", AT: "\\d{16}", AZ: "[\\dA-Z]{4}\\d{20}", BE: "\\d{12}", BH: "[A-Z]{4}[\\dA-Z]{14}", BA: "\\d{16}", BR: "\\d{23}[A-Z][\\dA-Z]", BG: "[A-Z]{4}\\d{6}[\\dA-Z]{8}", CR: "\\d{17}", HR: "\\d{17}", CY: "\\d{8}[\\dA-Z]{16}", CZ: "\\d{20}", DK: "\\d{14}", DO: "[A-Z]{4}\\d{20}", EE: "\\d{16}", FO: "\\d{14}", FI: "\\d{14}", FR: "\\d{10}[\\dA-Z]{11}\\d{2}", GE: "[\\dA-Z]{2}\\d{16}", DE: "\\d{18}", GI: "[A-Z]{4}[\\dA-Z]{15}", GR: "\\d{7}[\\dA-Z]{16}", GL: "\\d{14}", GT: "[\\dA-Z]{4}[\\dA-Z]{20}", HU: "\\d{24}", IS: "\\d{22}", IE: "[\\dA-Z]{4}\\d{14}", IL: "\\d{19}", IT: "[A-Z]\\d{10}[\\dA-Z]{12}", KZ: "\\d{3}[\\dA-Z]{13}", KW: "[A-Z]{4}[\\dA-Z]{22}", LV: "[A-Z]{4}[\\dA-Z]{13}", LB: "\\d{4}[\\dA-Z]{20}", LI: "\\d{5}[\\dA-Z]{12}", LT: "\\d{16}", LU: "\\d{3}[\\dA-Z]{13}", MK: "\\d{3}[\\dA-Z]{10}\\d{2}", MT: "[A-Z]{4}\\d{5}[\\dA-Z]{18}", MR: "\\d{23}", MU: "[A-Z]{4}\\d{19}[A-Z]{3}", MC: "\\d{10}[\\dA-Z]{11}\\d{2}", MD: "[\\dA-Z]{2}\\d{18}", ME: "\\d{18}", NL: "[A-Z]{4}\\d{10}", NO: "\\d{11}", PK: "[\\dA-Z]{4}\\d{16}", PS: "[\\dA-Z]{4}\\d{21}", PL: "\\d{24}", PT: "\\d{21}", RO: "[A-Z]{4}[\\dA-Z]{16}", SM: "[A-Z]\\d{10}[\\dA-Z]{12}", SA: "\\d{2}[\\dA-Z]{18}", RS: "\\d{18}", SK: "\\d{20}", SI: "\\d{15}", ES: "\\d{20}", SE: "\\d{20}", CH: "\\d{5}[\\dA-Z]{12}", TN: "\\d{20}", TR: "\\d{5}[\\dA-Z]{17}", AE: "\\d{3}\\d{16}", GB: "[A-Z]{4}\\d{14}", VG: "[\\dA-Z]{4}\\d{16}"}, r = o[a], "undefined" != typeof r && (s = new RegExp("^[A-Z]{2}\\d{2}" + r + "$", ""), !s.test(c)))
            return!1;
        for (d = c.substring(4, c.length) + c.substring(0, 4), l = 0; l < d.length; l++)
            i = d.charAt(l), "0" !== i && (A = !1), A || (f += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(i));
        for (u = 0; u < f.length; u++)
            n = f.charAt(u), p = "" + h + n, h = p % 97;
        return 1 === h
    ...
    }, "Please specify a valid NIF number."), jQuery.validator.addMethod("notEqualTo", function (e, a, d) {
        return this.optional(a) || !t.validator.methods.equalTo.call(this, e, a, d)
        ...
        var i = t(d[1], a.form), n = i.eq(0), r = n.data("valid_req_grp") ? n.data("valid_req_grp") : t.extend({}, this), o = i.filter(function () {
        ...
        var i = t(d[1], a.form), n = i.eq(0), r = n.data("valid_skip") ? n.data("valid_skip") : t.extend({}, this), o = i.filter(function () {
            return r.elementValue(this)
        }).length, s = 0 === o || o >= d[0];
        ...
        var d, i = "undefined" == typeof a, n = i || "undefined" == typeof a.caseSensitive ? !1 : a.caseSensitive, r = i || "undefined" == typeof a.includeTerritories ? !1 : a.includeTerritories, o = i || "undefined" == typeof a.includeMilitary ? !1 : a.includeMilitary;
    ...
    }, "Your ZIP-code must be in the range 902xx-xxxx to 905xx-xxxx"), t.validator.addMethod("youtube", function (t, e) {
        return this.optional(e) || /^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/.test(t)
    }, "Invalid youtube url.")
});